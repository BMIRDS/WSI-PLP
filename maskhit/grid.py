...
# Example Usage: CUDA_VISIBLE_DEVICES=8 python random_grid.py
# ------------------------------

# Define lists of hyperparameter values to experiment with
learning_rates_preds = [
    1e-1, 5e-2, 3e-2, 1e-2, 7e-3, 5e-3, 3e-3, 1e-3, 7e-4, 5e-4, 3e-4, 1e-4, 7e-5, 5e-5, 3e-5, 1e-5, 1e-6
]
weight_decay_preds = [
    5e-1, 3e-1, 2e-1, 1e-1, 7e-2, 5e-2, 3e-2, 2e-2, 1e-2, 7e-3, 5e-3, 3e-3, 2e-3, 1e-3, 7e-4, 5e-4, 3e-4, 1e-4
]
